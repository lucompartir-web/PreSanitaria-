# ✅ Corrección – Pack 1 (30 casos)

1 → Cambios posturales + hidratación piel  
2 → Retirar prótesis + gasas antisépticas  
3 → Limpieza ocular medial→lateral  
4 → Higiene genital adelante→atrás  
5 → Retirar prótesis auditiva  
6 → Fowler alta  
7 → Movilización en bloque  
8 → Soporte hombro + cojines  
9 → Grúa con frenos  
10 → Trendelenburg moderado  
11 → Azúcares rápidos  
12 → Dieta espesada + Fowler  
13 → Líquidos claros progresivos  
14 → Mitad micción  
15 → Esputo matutino  
16 → Checklist quirúrgico con alergias  
17 → Escala dolor + aviso equipo  
18 → Alivio presión  
19 → Apósito adecuado  
20 → Taloneras  
21 → Maniobra de Heimlich  
22 → RCP 30:2  
23 → Proteger entorno + lateral  
24 → Escucha activa  
25 → Rutinas seguras  
26 → Monitorizar SV + analgesia  
27 → Dieta espesada + acompañamiento  
